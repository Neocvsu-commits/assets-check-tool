...
CLASSES = (
    ...
    operators.ASSETSCHECKNEXT_OT_PresetMoveUp,
    operators.ASSETSCHECKNEXT_OT_PresetMoveDown,
    ...
    operators.ASSETSCHECKNEXT_OT_ResetUISize,
    ...
    operators.ASSETSCHECKNEXT_OT_RenameUVLayer,
    ...
    operators.ASSETSCHECKNEXT_MT_QF_UVName,
